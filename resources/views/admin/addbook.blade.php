          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              {{--<form id="quickForm">--}}
                ...
                @endif 
              {!!Form::open(['action'=>'App\Http\Controllers\BookController@savebook', 'method'=>'POST' , 'enctype'=>'multipart/form-data'])!!}
                {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('titre', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'Enter book title'])}}
                  </div>
                  <div class="form-group">
                    {{--<label for="exampleInputEmail1">Product name</label>
                    <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name">--}}
                    {{Form::label('', 'book autor' ,['for'=>'exampleInputEmail1'])}}
                    {{Form::text('auteur', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'Enter book autor'])}}
                  </div>
                  <div class="form-group">
                    {{--<label for="exampleInputEmail1">Product name</label>
                    <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name">--}}
                    {{Form::label('', 'book tags' ,['for'=>'exampleInputEmail1'])}}
                    {{Form::text('tags', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'Enter book tags'])}}
                  </div>
                  <div class="form-group">
                    {{--<label for="exampleInputEmail1">Product name</label>
                    <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name">--}}
                    {{Form::label('', 'book link' ,['for'=>'exampleInputEmail1'])}}
                    {{Form::text('direct_link', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'Enter book direct link'])}}
                  </div>
                  <div class="form-group">
                    {{Form::label('', 'book page number' ,['for'=>'exampleInputEmail1'])}}
                    {{Form::text('pages', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'book page number'])}}
                  </div>
                  <div class="form-group">
                    {{Form::label('', 'book year' ,['for'=>'exampleInputEmail1'])}}
                    {{Form::text('annee', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'Enter book year'])}}
                  </div>
                  <div class="form-group">
                    {{Form::label('', 'book description' ,['for'=>'exampleInputEmail1'])}}
                    {{Form::text('description', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'Enter book description'])}}
                  </div>
